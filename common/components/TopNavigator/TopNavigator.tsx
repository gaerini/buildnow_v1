...
const TopNavigator: React.FC<TopNavigatorProps> = ({ children }) => {
  return (
    <div
      className="sticky top-0 h-16 bg-primary-neutral-white border-b border-primary-navy-200 justify-between items-center inline-flex"
      style={{ zIndex: 1000 }}
    >
      <div className="flex items-center ml-8 w-full grow z-40">{children}</div>
