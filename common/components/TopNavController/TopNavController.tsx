  ...
  return (
    <div className="flex grow justify-between items-center w-full bg-primary-neutral-white">
      <div className="flex items-center">
        ...
        <span className={`ml-4 text-subTitle-20 font-bold ${companyNameClass}`}>
          {companyName}
        </span>
      ...
      <div className="flex items-center">
        <button
          className="btnStyle-main-2 btnSize-s text-primary-neutral-700 hover:text-primary-neutral-black  hover:bg-primary-neutral-100 flex gap-x-2 items-center"
          onClick={() => console.log("이전 업체 정보로 이동")}
        >
          <Icon name="ArrowLeft" width={16} height={16} />
          {companyBefore}
        </button>
        <span className="ml-2 text-paragraph-14 text-primary-navy-500">
          이전 업체
        </span>
        <span className="mx-4 text-paragraph-16 text-primary-navy-500">|</span>
        <span className="mr-2 text-paragraph-14 text-primary-navy-500">
          다음 업체
        </span>
        <button
          className="btnStyle-main-2 btnSize-s text-primary-neutral-700 hover:text-primary-neutral-black  hover:bg-primary-neutral-100 flex gap-x-2 items-center"
