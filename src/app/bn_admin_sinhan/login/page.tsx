...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data && response.data.includes("ROLE_ADMIN")) {
        router.push("list");
      } else {
        setError(true);
            ...
            <div className="flex flex-col w-full gap-y-2 justify-center">
              ...
              >
                ...
                <input
                  ...
                  className="flex-grow h-[48px] bg-transparent subTitle-18 border-transparent focus:border-transparent focus:ring-0 textColor-high-emphasis"
                  value={username}
