...
// React.memo를 사용하여 컴포넌트를 래핑합니다.
const RegisterLicenseByNumMemo = React.memo(RegisterLicenseByNum);
const WorkTypeMemo = React.memo(WorkType);
...
const Home = () => {
  ...
  const handleTempSave = async () => {
    ...
    console.log("기존 녀석", tempSaveList);
    ...
    console.log("입력값", updatedTempSaveList);
