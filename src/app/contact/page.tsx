  ...
  return (
    <div className="flex flex-col min-w-[1000px] gap-y-40 px-3 md:px-6 lg:px-12 xl:px-24 2xl:px-64">
      ...
      <div className="items-center px-8 grow ">
        <div className="flex items-start  gap-x-16 justify-center ">
          <div className="flex bg-white shadow-m px-8 py-8 flex-col gap-y-8 w-fit">
            ...
            <div>
              ...
              <textarea
                className={`w-[496px] h-[100px] bg-white rounded-s px-3 py-2 my-1 text-paragraph-16 ${
                  validation.inquiry
                    ? "border borderColor"
                    : "border border-danger-red"
                }`}
            ...
            <button
              className="btnStyle-main-1 btnSize-xl w-[496px] h-14 flex justify-center items-center"
              onClick={handleSubmit}
            >
              문의내용 접수
            </button>
          </div>
          <div className="flex flex-col w-fit px-8 whitespace-nowrap ">
